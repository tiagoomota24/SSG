...
const resources = {
  en: {
    translation: {
      ...
      introId:'Phishing involves using various methods to get the user to reveal personal and confidential data, such as their credit card numbers, bank account information, social security numbers, passwords, among others.',
      howItWorksId:'Phishers use various methods to obtain information, including spam, pop-up or email messages, posing as legitimate companies or organizations with which the potential victim does business - for example, their Internet service provider, bank, online payment services or even a government agency. These messages often claim that the user needs to "update" or "validate" their account information, even threatening negative consequences (such as closing the account) if there is no response. These techniques of threat and manipulation are called Social Engineering, which also includes the most seductive forms of persuasion, such as the "offer" of articles, trips or money over the Internet.',
  ...
  pt: {
    translation: {
      ...
      introId:'O phishing consiste em utilizar métodos vários que levem o utilizador a revelar dados pessoais e confidenciais, como os seus números de cartão de crédito, informação de contas bancárias, números de segurança social, passwords, entre outros.',
